<template>
  <QuickConsultView
    ...
    @back="$emit('back')"
  />
  <nav class="ab-quick-consult-form-nav" aria-label="AB 测试页面切换">
...
.ab-quick-consult-form-nav button {
  height: 32px;
  padding: 0 14px;
...
.ab-quick-consult-form-nav button:disabled {
  border-color: #d8dde1;
  background: #f2f3f4;
  color: #99a1af;
  cursor: not-allowed;
