<template>
  <QuickConsultView
    :patient-name-dot-variant="variant"
    ab-mode
    @back="$emit('back')"
  />
  <nav class="ab-quick-consult-name-dot-nav" aria-label="AB 测试页面切换">
    ...
    <button class="ab-quick-consult-name-dot-nav__help" type="button" aria-label="查看操作指引" title="查看操作指引" @click="$emit('show-guide')">?</button>
  </nav>
</template>
...
.ab-quick-consult-name-dot-nav button {
  height: 32px;
  padding: 0 14px;
...
.ab-quick-consult-name-dot-nav button:disabled {
  border-color: #d8dde1;
  background: #f2f3f4;
  color: #99a1af;
  cursor: not-allowed;
...
.ab-quick-consult-name-dot-nav .ab-quick-consult-name-dot-nav__help {
  width: 32px;
  padding: 0;
  border-color: #006ef9;
  background: #006ef9;
