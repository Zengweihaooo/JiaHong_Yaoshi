<template>
  ...
  <nav class="ab-quick-consult-consent-nav" aria-label="AB 测试页面切换">
    ...
    <button class="ab-quick-consult-consent-nav__help" type="button" aria-label="查看操作指引" title="查看操作指引" @click="$emit('show-guide')">?</button>
  </nav>
</template>
...
.ab-quick-consult-consent-nav .ab-quick-consult-consent-nav__help {
  width: 32px;
  padding: 0;
  border-color: #006ef9;
  background: #006ef9;
