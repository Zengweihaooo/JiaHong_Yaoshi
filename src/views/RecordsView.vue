...
.records-content { display: flex; flex-direction: column; height: calc(100vh - 64px); padding: 24px 24px 0; overflow: hidden; }
...
.batch-bar { display: flex; align-items: center; justify-content: space-between; margin-top: 16px; }.batch-actions { display: flex; gap: 16px; }.export { display: inline-flex; align-items: center; justify-content: center; width: 80px; padding: 0 10px; color: #006ef9; white-space: nowrap; }.wide { min-width: 172px; }.history-wrap { position: relative; }.history { min-width: 108px; }.history.active,.history.active:hover { border-color: #338bfa; color: #338bfa; background: #fff; box-shadow: 0 0 0 1px rgba(0,110,249,.08); }.history span { display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; margin-left: 6px; border-radius: 50%; color: #fff; font-size: 11px; background: #777; }.history:hover span,.history.active span { background: #1684ff; }.history-tip { position: absolute; right: 0; bottom: 44px; z-index: 80; width: 248px; padding: 42px 28px; border-radius: 4px; color: rgba(0,0,0,.85); font-size: 24px; line-height: 1.55; background: #fff; box-shadow: 0 14px 34px rgba(0,0,0,.14); }.history-tip::after { position: absolute; right: 54px; bottom: -10px; width: 20px; height: 20px; background: #fff; transform: rotate(45deg); content: ""; }.menu-wrap { position: relative; }.action-menu { position: absolute; z-index: 40; top: 36px; overflow: hidden; padding: 4px; border: 1px solid #e5e8eb; border-radius: 6px; background: #fff; box-shadow: 0 5px 12px rgba(0,0,0,.18); }.action-menu button { display: block; width: 100%; height: 32px; padding: 0 10px; border: 0; color: rgba(0,0,0,.9); text-align: left; background: #fff; transition: color .15s, background .15s; }.action-menu button:hover { color: #006ef9; background: #edf5ff; }.action-menu button.danger:hover { color: #d54941; background: #fff1f0; }.export-menu { left: 0; width: 142px; }
...
@media (max-width: 1300px) { .records-nav { gap: 10px; padding-inline: 40px; }.records-content { padding: 20px 20px 0; }.filter-grid { gap-inline: 16px; } }
</style>
