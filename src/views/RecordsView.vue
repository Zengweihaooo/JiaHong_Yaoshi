...
const optionMap = { "问诊类型": ["全部", "图文问诊", "视频问诊"], "问诊状态": ["全部", "完成问诊", "取消问诊"], "支付状态": ["全部", "无", "未支付", "已支付"], "审方状态": ["全部", "未申请", "待修改", "未审核", "未签名", "已完成", "已作废"], "药品实名": ["全部", "是", "否"], "药品名称": ["全部", "草酸艾司西酞普兰片", "感冒片", "感冒灵胶囊"], "问诊号": ["全部", "WZ001", "WZ002", "WZ003"] };
...
const seedRecords = [
  ...
  { type: "图文问诊", status: "完成问诊", payment: "无", audit: "已作废", diagnosis: "抑郁症", medicine: "草酸艾司西酞普兰片" },
  { type: "视频问诊", status: "完成问诊", payment: "未支付", audit: "未审核", diagnosis: "感冒", medicine: "感冒片" },
  { type: "图文问诊", status: "完成问诊", payment: "已支付", audit: "待修改", diagnosis: "焦虑症", medicine: "草酸艾司西酞普兰片" },
  { type: "视频问诊", status: "完成问诊", payment: "已支付", audit: "未申请", diagnosis: "感冒", medicine: "感冒灵胶囊" }
];
...
.filter-card { position: relative; z-index: 20; height: 208px; padding: 16px 24px; overflow: visible; }
